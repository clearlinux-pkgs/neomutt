...
Version  : 20250510
Release  : 42
URL      : https://github.com/neomutt/neomutt/archive/20250510/neomutt-20250510.tar.gz
Source0  : https://github.com/neomutt/neomutt/archive/20250510/neomutt-20250510.tar.gz
...
%prep
%setup -q -n neomutt-20250510
cd %{_builddir}/neomutt-20250510
%patch -P 1 -p1
pushd ..
cp -a neomutt-20250510 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747067178
