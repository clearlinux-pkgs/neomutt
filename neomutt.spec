...
Version  : 20240329
Release  : 32
URL      : https://github.com/neomutt/neomutt/archive/20240329/neomutt-20240329.tar.gz
Source0  : https://github.com/neomutt/neomutt/archive/20240329/neomutt-20240329.tar.gz
...
%prep
%setup -q -n neomutt-20240329
cd %{_builddir}/neomutt-20240329
%patch -P 1 -p1
pushd ..
cp -a neomutt-20240329 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711838579
