...
Source0  : https://github.com/neomutt/neomutt/archive/20200626.tar.gz
...
%prep
%setup -q -n neomutt-20200626
cd %{_builddir}/neomutt-20200626
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597433102
...
cp %{_builddir}/neomutt-20200626/LICENSE.md %{buildroot}/usr/share/package-licenses/neomutt/b11b797fa13b0935d0e0b13a84f7dd413f9d6ab3
cp %{_builddir}/neomutt-20200626/autosetup/LICENSE %{buildroot}/usr/share/package-licenses/neomutt/34b2f1d7acba3eeb992e4281307640989cd08d0a
cp %{_builddir}/neomutt-20200626/contrib/keybase/LICENSE %{buildroot}/usr/share/package-licenses/neomutt/24944bf7920108f5a4790e6071c32e9102760c37
%make_install
%find_lang neomutt
