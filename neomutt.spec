...
Version  : 20241002
Release  : 35
URL      : https://github.com/neomutt/neomutt/archive/20241002/neomutt-20241002.tar.gz
Source0  : https://github.com/neomutt/neomutt/archive/20241002/neomutt-20241002.tar.gz
...
%prep
%setup -q -n neomutt-20241002
cd %{_builddir}/neomutt-20241002
%patch -P 1 -p1
pushd ..
cp -a neomutt-20241002 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727897573
