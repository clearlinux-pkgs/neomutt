...
Version  : 20220408
Release  : 15
URL      : https://github.com/neomutt/neomutt/archive/20220408/neomutt-20220408.tar.gz
Source0  : https://github.com/neomutt/neomutt/archive/20220408/neomutt-20220408.tar.gz
...
%prep
%setup -q -n neomutt-20220408
cd %{_builddir}/neomutt-20220408
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649428624
...
cp %{_builddir}/neomutt-20220408/LICENSE.md %{buildroot}/usr/share/package-licenses/neomutt/b11b797fa13b0935d0e0b13a84f7dd413f9d6ab3
cp %{_builddir}/neomutt-20220408/autosetup/LICENSE %{buildroot}/usr/share/package-licenses/neomutt/34b2f1d7acba3eeb992e4281307640989cd08d0a
cp %{_builddir}/neomutt-20220408/contrib/keybase/LICENSE %{buildroot}/usr/share/package-licenses/neomutt/24944bf7920108f5a4790e6071c32e9102760c37
%make_install
%find_lang neomutt
