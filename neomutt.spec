...
Version  : 20240201
Release  : 30
URL      : https://github.com/neomutt/neomutt/archive/20240201/neomutt-20240201.tar.gz
Source0  : https://github.com/neomutt/neomutt/archive/20240201/neomutt-20240201.tar.gz
...
%prep
%setup -q -n neomutt-20240201
cd %{_builddir}/neomutt-20240201
%patch -P 1 -p1
pushd ..
cp -a neomutt-20240201 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706800014
