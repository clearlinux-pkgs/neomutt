...
Version  : 20250113
Release  : 39
URL      : https://github.com/neomutt/neomutt/archive/20250113/neomutt-20250113.tar.gz
Source0  : https://github.com/neomutt/neomutt/archive/20250113/neomutt-20250113.tar.gz
...
%prep
%setup -q -n neomutt-20250113
cd %{_builddir}/neomutt-20250113
%patch -P 1 -p1
pushd ..
cp -a neomutt-20250113 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736780340
